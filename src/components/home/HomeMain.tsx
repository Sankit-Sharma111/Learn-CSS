...
export function HomeMain() {
  ...
  return (
    <div className="p-5 pb-24 max-w-5xl mx-auto bg-slate-50 dark:bg-slate-900 min-h-screen transition-colors">
      <h1 className="text-2xl font-bold text-slate-800 dark:text-white mb-6 tracking-tight">
        Sankit Accademy
      </h1>

      {/* Premium Banner */}
      <div className="w-full text-left bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl p-6 text-white shadow-lg shadow-indigo-200 dark:shadow-none mb-8 relative overflow-hidden">
      ...
      <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-4 leading-tight">
        {t.startJourney}
      </h3>
